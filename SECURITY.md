...
- **GitHub**: Open a [private security advisory](https://github.com/vmware-skills/VMware-NSX-Security/security/advisories/new)
...
- Each NSX Manager target uses a separate environment variable: `VMWARE_NSX_SECURITY_<TARGET_NAME_UPPER>_PASSWORD`
...
```bash
uvx bandit -r vmware_nsx_security/
```
