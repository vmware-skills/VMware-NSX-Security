...
ENTITY_WORDS = {
    'group': ('group', 'groups'),
    'policy': ('policy', 'policies', 'dfw_policy', 'dfw_policies'),
    'rule': ('rule', 'rules', 'dfw_rule', 'dfw_rules'),
    'traceflow': ('traceflow', 'traceflows'),
    'vm': ('vm', 'vms', 'vm_display'),
    'lport': ('lport', 'lports', 'port', 'ports', 'src_lport'),
}
...
NOT_AN_ENTITY = frozenset(
    {
        # ``display_name`` names the policy/rule/group being created. Tag scope
        # and value are free text the operator supplies.
        'display_name',
        'tag_scope',
        'tag_value',
    }
