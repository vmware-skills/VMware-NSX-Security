...
``VMWARE_NSX_SECURITY_CONFIG``, then ``CONFIG_FILE`` — was consolidated into
...
from vmware_nsx_security.config import CONFIG_FILE, resolve_config_path

_ENV = "VMWARE_NSX_SECURITY_CONFIG"
...
def test_the_server_hands_the_loader_the_resolvers_own_default():
    ...
    from vmware_nsx_security import policy_environment
